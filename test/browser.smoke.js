...
try {
  ...
  await page.locator('[name="scheduleTime"]').fill('07:00')
  await page.locator('[name="scheduleEndTime"]').fill('09:00')
  ...
  console.log('Browser smoke passed: queue stages, manual polling, async webhook test, random window form, desktop/mobile screenshots, no browser fallback.')
} finally {
  await browser.close()
